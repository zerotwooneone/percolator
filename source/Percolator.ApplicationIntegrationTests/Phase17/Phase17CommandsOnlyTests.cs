...
public class Phase17CommandsOnlyTests : IntegrationTestBase
{
    ...
    public async Task Step17_EndToEnd_Via_Application_Commands_Using_Loopback()
    {
        ...
        // GroupV1-specific steps removed (group creation, messaging, admin operations)
        Assert.Pass("Phase 17 non-group infrastructure (handshakes, DHT) executed via application commands with loopback transport.");
    }
}
