...
public interface ISentInvitationRepository
{
    ...
    Task SetInviteRouteAsync(RequestCorrelationId requestCorrelationId, CryptoSelfId selfIdentityId, InviteRouteKind routeKind, CryptoPeerId? relayHostPeerId, CancellationToken cancellationToken = default);
