...
public sealed class SimulatorRelayTabViewModelTests
{
    private sealed class StateStub : ISimulatorStateService
    {
        ...
        public System.Threading.Tasks.Task PublishStandardPreKeyBundleToRelayAsync(Guid simulatedPeerId, Guid relayHostPeerId, DateTimeOffset expiresUtc, int oneTimeKeyCount, System.Threading.CancellationToken cancellationToken = default) => throw new NotImplementedException();
