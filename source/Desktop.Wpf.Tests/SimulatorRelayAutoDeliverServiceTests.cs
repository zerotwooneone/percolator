...
public sealed class SimulatorRelayAutoDeliverServiceTests
{
    ...
    private sealed class StateStub : ISimulatorStateService
    {
        ...
        public Task PublishStandardPreKeyBundleToRelayAsync(Guid simulatedPeerId, Guid relayHostPeerId, DateTimeOffset expiresUtc, bool includeOneTimeKeys, int oneTimeKeyCount, CancellationToken cancellationToken = default) => throw new NotImplementedException();
