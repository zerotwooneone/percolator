...
public class Message
{
    ...
    internal void AddReaction(ParticipantId reactorId, string emoji)
    {
    ...
    internal void RemoveReaction(ParticipantId reactorId, string emoji)
    {
    ...
    internal void AddReadReceipt(ParticipantId readerId)
    {
