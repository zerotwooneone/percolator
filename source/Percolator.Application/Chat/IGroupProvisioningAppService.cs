...
public interface IGroupProvisioningAppService
{
    ...
    /// <param name="selfParticipant">The composite identity of the local user creating the group.</param>
    /// <param name="invitees">List of composite identities for members to invite.</param>
    /// <param name="relayParticipant">The composite identity of the relay to use for group provisioning.</param>
