...
public interface ISecureMessagingService
{
    ...
    Task<(SessionId sessionId, Plaintext plaintext)?> DecryptInboundAsync(uint selfIdentityId, SessionRatchetMessage message, CancellationToken cancellationToken = default);
}
