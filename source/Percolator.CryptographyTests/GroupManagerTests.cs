...
namespace Percolator.Cryptography.Tests
{
    ...
    public class GroupManagerTests
    {
        ...
        public void FullGroupLifecycle_ShouldSucceed()
        {
            ...
            var sessionToAlice = DoubleRatchetSession.AsInitiator(sharedSecretAlice, _creatorIdentity, new PublicKey(_aliceIdentity.PublicKey.ExportSubjectPublicKeyInfo()), new PublicKey(_aliceRatchet.PublicKey.ExportSubjectPublicKeyInfo()));
            var sharedSecretBob = new SharedSecret(_creatorIdentity.DeriveKeyMaterial(_bobIdentity.PublicKey));
            var sessionToBob = DoubleRatchetSession.AsInitiator(sharedSecretBob, _creatorIdentity, new PublicKey(_bobIdentity.PublicKey.ExportSubjectPublicKeyInfo()), new PublicKey(_bobRatchet.PublicKey.ExportSubjectPublicKeyInfo()));
            ...
            var sessionFromAlice = DoubleRatchetSession.AsResponder(sharedSecretAlice, _aliceIdentity, new PublicKey(_creatorIdentity.PublicKey.ExportSubjectPublicKeyInfo()), _aliceRatchet);
            ...
            var sessionFromBob = DoubleRatchetSession.AsResponder(sharedSecretBob, _bobIdentity, new PublicKey(_creatorIdentity.PublicKey.ExportSubjectPublicKeyInfo()), _bobRatchet);
        ...
        public void AcceptInvitation_WithTamperedSignature_ThrowsException()
        {
            ...
            var sessionToAlice = DoubleRatchetSession.AsInitiator(sharedSecret, _creatorIdentity, new PublicKey(_aliceIdentity.PublicKey.ExportSubjectPublicKeyInfo()), new PublicKey(_aliceRatchet.PublicKey.ExportSubjectPublicKeyInfo()));
            ...
            // Act & Assert
            var sessionFromAlice = DoubleRatchetSession.AsResponder(sharedSecret, _aliceIdentity, new PublicKey(_creatorIdentity.PublicKey.ExportSubjectPublicKeyInfo()), _aliceRatchet);
        ...
        public void NonCreator_CannotPerformAdminActions()
        {
            ...
            var sessionToBobForAlice = DoubleRatchetSession.AsInitiator(sharedSecretBob, _aliceIdentity, new PublicKey(_bobIdentity.PublicKey.ExportSubjectPublicKeyInfo()), new PublicKey(_bobRatchet.PublicKey.ExportSubjectPublicKeyInfo()));
        ...
        public void ProcessRekeyMessage_WithMismatchedGroupId_ThrowsException()
        {
            ...
            var sessionToBobForA = DoubleRatchetSession.AsInitiator(sharedSecretA, _creatorIdentity, new PublicKey(_bobIdentity.PublicKey.ExportSubjectPublicKeyInfo()), new PublicKey(_bobRatchet.PublicKey.ExportSubjectPublicKeyInfo()));
            var invitationA = groupAManager.CreateInvitation("bob", sessionToBobForA);
            using var sessionFromBobForA = DoubleRatchetSession.AsResponder(sharedSecretA, _bobIdentity, new PublicKey(_creatorIdentity.PublicKey.ExportSubjectPublicKeyInfo()), _bobRatchet);
            ...
            var sessionToBobForB = DoubleRatchetSession.AsInitiator(sharedSecretB, _creatorIdentity, new PublicKey(_bobIdentity.PublicKey.ExportSubjectPublicKeyInfo()), new PublicKey(bobRatchetB.PublicKey.ExportSubjectPublicKeyInfo()));
            var invitationB = groupBManager.CreateInvitation("bob", sessionToBobForB);
            using var sessionFromBobForB = DoubleRatchetSession.AsResponder(sharedSecretB, _bobIdentity, new PublicKey(_creatorIdentity.PublicKey.ExportSubjectPublicKeyInfo()), bobRatchetB);
            ...
            var sessionToDummy = DoubleRatchetSession.AsInitiator(sharedSecretDummy, _creatorIdentity, new PublicKey(dummyIdentity.PublicKey.ExportSubjectPublicKeyInfo()), new PublicKey(dummyRatchet.PublicKey.ExportSubjectPublicKeyInfo()));
        ...
        public void AcceptInvitation_WithTamperedUnsignedMessage_ThrowsException()
        {
            ...
            var sessionToAlice = DoubleRatchetSession.AsInitiator(
                ...
                new PublicKey(_aliceRatchet.PublicKey.ExportSubjectPublicKeyInfo()));
            ...
            var sessionFromAlice = DoubleRatchetSession.AsResponder(
                new SharedSecret(_creatorIdentity.DeriveKeyMaterial(_aliceIdentity.PublicKey)),
                _aliceIdentity,
                new PublicKey(_creatorIdentity.PublicKey.ExportSubjectPublicKeyInfo()),
                _aliceRatchet);
