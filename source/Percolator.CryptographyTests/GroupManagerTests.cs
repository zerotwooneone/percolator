...
namespace Percolator.CryptographyTests
{
    ...
    public class GroupManagerTests
    {
        ...
        public void FullGroupLifecycle_ShouldSucceed()
        {
            ...
            var creatorManager = new GroupManager(_creatorIdentity, _loggerFactory);
            ...
            var loadedCreatorManager = GroupManager.LoadState(savedState, _masterKey, _creatorIdentity, _loggerFactory);
        ...
        public void ProcessRekeyMessage_WithMismatchedGroupId_ThrowsException()
        {
            ...
            var groupAManager = new GroupManager(_creatorIdentity, _loggerFactory);
            var groupBManager = new GroupManager(_creatorIdentity, _loggerFactory);
