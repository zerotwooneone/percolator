...
public class AeadSessionCryptoX3dhTests
{
    ...
    public void X3DH_Initiate_WithInvalidSignature_Throws()
    {
        ...
        var identity = new RatchetIdentityKey(identitySpki);
        ...
        var spkPub = new PreKey(spk.PublicKey.ExportSubjectPublicKeyInfo());
        // Signature is invalid (random bytes)
        var signature = new Signature(RandomNumberGenerator.GetBytes(64));
        ...
        var localPriv = new PrivatePreKey(ikA.ExportECPrivateKey());
