...
public class SecureSessionX3dhRoundtripTests
{
    ...
    public void Establish_and_roundtrip_messages_in_both_directions_using_real_crypto()
    {
        ...
        var a = SecureSession.Create(SessionId.NewId(), new CryptoPeerId(1), new ProtocolVersion(1), initiatorState, crypto, clock);
        var b = SecureSession.Create(SessionId.NewId(), new CryptoPeerId(1), new ProtocolVersion(1), responderState, crypto, clock);
