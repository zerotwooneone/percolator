...
public class DispatchReadReceiptHandlerTests
{
    ...
    private readonly DispatchReadReceiptHandler _sut;
    ...
    public DispatchReadReceiptHandlerTests()
    {
        ...
        _logger = NullLogger<DispatchReadReceiptHandler>.Instance;
        _sut = new DispatchReadReceiptHandler(_mediatorMock.Object, _senderMock.Object, _keyStoreMock.Object, _logger);
    }
